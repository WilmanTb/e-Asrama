...
public class Activity_Desc_Ijin_Keluar_Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desc_ijin_keluar_admin);
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    private void confirmIjin(){
        dbIjinKeluar.child("IjinKeluar").orderByChild("id_ijin").equalTo(id_ijin).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot:snapshot.getChildren()){
                    String key = dataSnapshot.getKey();
                    dbIjinKeluar.child("IjinKeluar").child(key).child("status").setValue("diterima");
                }
                Toast.makeText(Activity_Desc_Ijin_Keluar_Admin.this, "Permintaan ijin berhasil dikonfirmasi", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Activity_Desc_Ijin_Keluar_Admin.this, Activity_Dashboard_Admin.class));
                finish();
            }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(this, Activity_Ijin_Keluar_Admin.class));
        finish();
    }
}